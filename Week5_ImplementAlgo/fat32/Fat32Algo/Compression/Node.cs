// <copyright file="Node.cs" company="Nate Bachmeier">
...
namespace Fat32Algo.Compression
{
    ...
    public class Node : IComparable<Node>, IComparer<Node>
    {
        ...
        /// </summary>
        /// <returns>Textual string.</returns>
        public override string ToString()
        {
            return $"Value={this.Value}, F={this.Frequency}, Left={this.Left?.Frequency}, Right={this.Right?.Frequency}";
        }
